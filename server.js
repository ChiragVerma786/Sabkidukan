...
var SignupSchema1 = new mongoose.Schema({name:String,phone:String,email:{unique:true,type:String},
    password:String,buisnessname:String,usertype:String,buisnesstype:String,address:String,pic:String,pincode:String},{versionKey:false});
var SignupModel1 = mongoose.model("signupmodel1",SignupSchema1,"signup1"); //if the collection name(3rd argument won't be given then it will make the plural of the Model name
...
server.post("/api/signup",upload.single('pic'),(req,res)=>{
    ...
    var newsignup1 = new SignupModel1({name:req.body.pname,phone:req.body.phone,email:req.body.emailname,buisnesstype:req.body.buisnesstype,password:req.body.pass,usertype:"normal",address:req.body.address,pic:picname,buisnessname:req.body.buisnessname,pincode:req.body.pincode});                    
...
server.post("/api/login",(req,res)=>{
    ...
    SignupModel1.find({email:req.body.uname,password:req.body.pass},function(err,data){
...
{
    var newadvt = new AdvtModel({Gender:req.body.gender,Advertisement:req.body.adv});
